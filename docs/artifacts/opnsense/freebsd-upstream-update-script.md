Searching for an industry standard solution to upstreaming, I found this script by Miha Kralj; It's a fantastic starting point, but it requires jq, and pipes in very long strings into  sh. 
```
#!/bin/sh
